...
<body>
		...
		<div class="container-fluid">
			...
			<div>
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="userprofile.jsp"> Edit Profile
					</a></li>
	...
	<div class="container">
		...
		<p class="lead">
			Mail ID:
			<%
			out.print(account.get_mail_id());
		%>
			<br> Name:
			<%
				out.print(account.get_name());
			%>
			<br> Contact Number:
			<%
				out.print(account.get_contact_number());
			%>
			<br> Address:
			<%
				out.print(account.get_address());
			%>
		</p>
		<br>
		<h2>Edit Profile:</h2>
		...
		<form action="Userprofile" method="post" role="form">
			...
			<input type="text" name="contact_number" class="form-control"></input><br>
			<h4>Address:</h4>
			<input type="text" name="address" class="form-control"></input><br>
			<h4>New Password for account:</h4>
		...
		<br> <a class="lead" href="Homepage.jsp"> Go to Homepage </a>
		<%
			}
		%>
		<br>
