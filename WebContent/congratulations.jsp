...
<body>
	...
	<div class="container">
		...
		<p class="lead">
			You have successfully booked a room.<br> Your Booking Id is :
			<%
			out.print(session.getAttribute("booking_id"));
		%>
			<br> Please note your booking id for future referneces.
		</p>
