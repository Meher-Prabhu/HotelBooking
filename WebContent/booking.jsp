...
<form name="details" action="Bookinginfo" method="post" role = "form" class = "form-horizontal">
...
<div class = "col-sm-6">
<input type="text" name="type_of_room" class = "form-control" readonly value="<% out.print(request.getParameter("department")); %>"></div></div>

<div class = "form-group">
<label class = "col-sm-2 control-label">Number of rooms: </label>
<div class = "col-sm-6">
<input type="number" name="num_rooms" class = "form-control" readonly value="<% out.print(request.getParameter("num_rooms")); %>"></div></div>
<div class = "form-group">
<label class = "col-sm-2 control-label">Start Date: </label>
<div class = "col-sm-6">
<input type = "date" class = "form-control" readonly value="<% out.print((String)session.getAttribute("start_date")); %>"></div></div>
<div class = "form-group">
<label class = "col-sm-2 control-label">End Date: </label>
<div class = "col-sm-6">
<input type = "date" class = "form-control" readonly value="<% out.print((String)session.getAttribute("end_date")); %>"></div></div>
<div class = "col-sm-10" style = "text-align:center">
<input type="submit" class = "btn btn-success"></input></div>
</form>
<% } %>
</div>
</body>
