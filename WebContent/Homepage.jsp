...
<form class = "form-inline" name="Search" action="Hotelinfo" method="post" role = "form">
City: <input type = "text" list="cities" name="city" onchange="fillAreas()" class = "form-control"></input>
Area: <input type="text" list="areas" name="area" class = "form-control"></input><br><br>
Start date of booking: <input type="date" name="start_date" class = "form-control"></input>
End date of booking: <input type="date" name="end_date" class = "form-control"></input><br>
<br>
...
<input type="submit" name="cancel" class = "btn btn-danger" value="Cancel a previous booking"></input>
</form>
<br>
</div>
<% } %>
