...
<body>
	...
	<div class="container">
		...
		<form name="hotelAdd" action="Hotelchanges" method="Post" role="form">
			...
			<br> Area of hotel*: <input type="text" name="area"
				class="form-control"> <br> City*: <input type="text"
				name="city" class="form-control"> <br> Phone number*: <input
				type="number" name="phone" class="form-control"> <br>
			Max booking period*: <input type="number" name="period"
