...
<h4>Enter details of the new room type:</h4> <br>
Room type name : <input type="text" name="room_type" value="" class = "form-control"><br>
Price : <input type="number" name="price" value="" class = "form-control"><br>
Capacity : <input type="number" name="capacity" value="" class = "form-control"><br>
Amenities provided in the room type (comma seperated, no spaces around commas) : <input type="text" name="amenities" value="" class = "form-control"><br>
